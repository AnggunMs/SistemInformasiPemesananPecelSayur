...
<head>
    ...
    <link href="assets/img/Icon1.png" rel="shotcot icon"/>
    <!-- GOOGLE FONTS-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Pecel Keliling</a>
            </div>
            <div style="color: yellow;
            padding: 15px 50px 5px 50px;
            float: right;
            font-size: 16px;"><?php include 'date.php' ?> </div>
        </nav>
        <!-- /. NAV TOP  -->
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li><a href="index.php?halaman=pembelian"><i class="fa fa-truck fa-3x"></i> Pembelian</a></li>
